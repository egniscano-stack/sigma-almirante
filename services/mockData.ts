...
export const MOCK_TAXPAYERS: Taxpayer[] = [
  {
    ...
    commercialName: 'Super Almirante Principal',
    docId: '155698888',
    dv: '22',
    name: 'Supermercado Almirante S.A.',
    address: 'Calle Principal, Almirante (Cabecera)',
    phone: '758-4444',
    email: 'conta@superalmirante.com',
  ...
  },
  {
    ...
    address: 'Barrio Francés, Calle Central',
    phone: '6655-8899',
  ...
  },
  {
    ...
    address: 'Barriada Guaymí, Parada de Buses',
    phone: '6600-1122',
