...
const FILES_TO_PROCESS = [
  { file: 'farmacia.xlsx', category: 'FARMACIA', prefix: 'FA' },
  { file: 'ferreteria.xlsx', category: 'FERRETERIA', prefix: 'FE' },
  { file: 'Gasolinera.xlsx', category: 'GASOLINERA', prefix: 'GA' },
  { file: 'lava auto.xlsx', category: 'LAVA AUTO', prefix: 'LA' },
  { file: 'legumbreria.xlsx', category: 'LEGUMBRERIA', prefix: 'LE' },
  { file: 'Otros.xlsx', category: 'OTROS', prefix: 'OT' },
  { file: 'Parqueo.xlsx', category: 'PARQUEO', prefix: 'PA' }
];

async function run() {
  console.log(`--- Iniciando Carga Masiva (Fase 2) en ${supabaseUrl} ---`);
